    ...
    <div class="session-panel-footer" @mousedown.stop="">
      <div class="session-tool-warp">
        ...
        <label class="session-tool-item">
          ...
          <input type="file" accept="image/png, image/jpg, image/jpeg, image/gif" @change="fileChange">
        </label>
    ...
    methods:{
      ...
      fileChange(e){
       // const reg = /\.(?:png|jpg|jpeg)$/i;
        ...
        reader.onloadend =()=> {
          let html="<img style='max-height: 120px' src='"+reader.result+"'>";
